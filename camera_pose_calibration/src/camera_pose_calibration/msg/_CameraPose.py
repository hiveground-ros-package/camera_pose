"""autogenerated by genpy from camera_pose_calibration/CameraPose.msg. Do not edit."""
import sys
...
class CameraPose(genpy.Message):
  _md5sum = "eb4c53d8c0c861e2c5d562bd921bb38e"
  _type = "camera_pose_calibration/CameraPose"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """string camera_id
...
"""
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(CameraPose, self).__init__(*args, **kwds)
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.camera_id = str[start:end].decode('utf-8')
      else:
